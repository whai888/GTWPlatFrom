...
import com.sq.core.gtw.edit.FlowMgnPubBizCreateSubEdit;
 ...
 *@创建日期 2013-8-18
 *@版本 V1.0
 *@文件名 BizDefinitionView.java
 */
public class BizDefinitionView extends ViewPart {

	public static final String ID = "com.sq.core.gtw.view.pub.BizDefinitionView"; //$NON-NLS-1$

	public BizDefinitionView() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(ConstantUtil.BIZ_DEFINITION_VIEW);
	...
	private void createActions() {
		...
		doubleClickAction = new Action() {
			public void run() {
				...
				Object obj = ((IStructuredSelection) selection).getFirstElement();
				String bizName = (String) obj;
				String editId = FlowMgnPubBizCreateSubEdit.ID ;
				IEditorInput input = new FlowMgnPubBizCreateSubEditorInput(bizName);
				try {
