...
public class DataMgnInsertDetailPage implements IDetailsPage {
	...
	public void createContents(Composite parent) {
	   ...
	   keyPropertylable.setToolTipText("标记一个属性，MyBatis会通过getGeneratedKeys或者通过insert语句的selectKey子元素设置它的值，默认：不设置");
	   ...
	   useGeneratedKeyslable.setToolTipText("这会告诉MyBatis使用JDBC的getGeneratedKeys方法来取出由数据(比如：像MySQL和SQL Server这样的数据库管理系统的自动递增字段)内部生成的主键。");
