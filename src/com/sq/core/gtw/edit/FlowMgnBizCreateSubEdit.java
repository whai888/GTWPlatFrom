 ...
 *@创建日期 2013-8-17
 *@版本 V1.0
 *@文件名 FlowMgnBizCreateSubEdit.java
 */
public class FlowMgnBizCreateSubEdit extends EditorPart {

	public static final String ID = "com.sq.core.gtw.edit.FlowMgnBizCreateSubEdit"; //$NON-NLS-1$
	...
	public FlowMgnBizCreateSubEdit() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		label_9.setToolTipText("实现的类名必须实现接口");
		label_9.setText("实现类名：");
	...
	private void createActions() {
		...
		deleteBiz = new Action(){
			...
			public void run() {
				...
				tableViewer.setInput(flowBizPaletteInfo);
				tableViewer.refresh();
			}
	...
	public void doSave(IProgressMonitor monitor) {
		...
		bizTransInfo.setDefinitionBiz(bizPaletteInfoList);
		XMLFileOp.saveToFile(bizPath, bizTransInfo, null);
		tableViewer.refresh();
		isflushDirty(false);
	}
	...
	public void initXmlBizData(){
		FlowMgnBizCreateSubEditorInput flowMgnBizCreateSubEditorInput = null ;
		flowMgnBizCreateSubEditorInput = (FlowMgnBizCreateSubEditorInput)this.getEditorInput();
		bizPath = flowMgnBizCreateSubEditorInput.getPath().toString();
		...
		if(bizTransInfo != null)
			bizPaletteInfoList = bizTransInfo.getDefinitionBiz() ;
