 ...
 * @创建日期 2013-7-3
 * @版本 V1.0
 * @文件名 FlowBizCustomXYLayoutEditPolicy.java
 */
public class FlowBizCustomXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	protected Command getCreateCommand(CreateRequest request) {
		...
		//获得新创建的图形
		BizModel model = (BizModel)request.getNewObject();
		//为该图形设置签名获得的位置和尺寸
