 ...
 * @创建日期 2013-7-2
 * @版本 V1.0
 * @文件名 PkgMgnTextEdit.java
 */
public class PkgMgnTextEdit extends EditorPart {
	public PkgMgnTextEdit() {
	}

	public static final String ID = "com.sq.core.gtw.edit.PkgMgnTextEdit"; //$NON-NLS-1$
...
//		gridData.grabExcessHorizontalSpace = true;//抢占水平方向额外空间 
	...
	private void initData() {
		...
		packInfoList = (List<BizPackageInfo>) XMLFileOp.readToFile(pkgPath, xstream);
		if(packInfoList == null)
			packInfoList = new ArrayList<BizPackageInfo>() ;
	}
	...
	public void doSave(IProgressMonitor monitor) {
		...
		XMLFileOp.saveToFile(pkgPath, packInfoList, null);
		//刷新试图
		isflushDirty(false);
	}
